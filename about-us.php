                    ...
                    <div class="about-progress-inner">
                        ...
                        <div class="inner">
                            <article>
                                ...
                                <p class="disc">
                                    Over the past 28 years, we have been able to expand our areas of
                                ...
                                <p class="disc">
                                    ...
                                    As a company which holds the CIDA EM2 certificate of merit, we
                            ...
                            <a href="contactus.php" class="rts-btn btn-primary">Make an Appointment</a>
                        </div>
                        <!-- end -->
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="faq-two-inner">
                        <div class="title-area-faq">
                            ...
                            <h2 class="title">AREAS OF <span>SPECIALISATION</span></h2>
                        </div>
                        <!-- faq accordion area -->
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingOne">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                            ...
                                            <span>01. </span> Specialized Service
                                        </button>
                                    </h2>
            ...
            <div class="row g-5 mt--20">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                    <div class="testimopnial-wrapper-two">
                        ...
                        <div class="test-body">
                            <p class="disc">
                                “To pursue dynamic progress in everything we do while preserving the core values of the
                                company”
                            </p>
                        </div>
                    </div>
